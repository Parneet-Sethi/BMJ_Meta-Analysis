...
*********************************************************************************
clear
import excel "S:\MNHS-SPHPM-School\MCHRI\Biostats and Big Data Group\WHO systematic review\Results_Parneet\WHO results Parneet\below\template_who_inadequate weight gain final updated", sheet("sheet1") firstrow
...
*Meta-Forest. 
cd "S:\MNHS-SPHPM-School\MCHRI\Biostats and Big Data Group\WHO systematic review\Results_Parneet\WHO results Parneet\below\graphs"
...
********************************************************************************************************************************************************
********************************************************************************************************************************************************
//RUN FOREST PLOT AND EGGERS TEST
cd "S:\MNHS-SPHPM-School\MCHRI\Biostats and Big Data Group\WHO systematic review\Results_Parneet\WHO results Parneet\below\Funnelplots"
...
**meta forest. 
cd "S:\MNHS-SPHPM-School\MCHRI\Biostats and Big Data Group\WHO systematic review\Results_Parneet\WHO results Parneet\hksj senstivity\below\graphs"
levelsof outcome_new, local(levels) 
 foreach l of local levels {
 	local label: label (outcome_new) `l'
		if "`label'" == "hyperbilirubinaemia" {
...
*************************************************************************************************************************************************************
clear
import excel "S:\MNHS-SPHPM-School\MCHRI\Biostats and Big Data Group\WHO systematic review\Results_Parneet\Addressing feedback from BMJ\WHO results Parneet crude vs adjusted\below\template_who_inadequate weight gain final updated", sheet("sheet1") firstrow
