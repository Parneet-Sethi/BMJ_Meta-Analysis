...
*********************************************************************************
*********************************************************************************
*ASIAN RESULTS-WEIGHT GAIN BELOW THE NORMAL WEIGHT GAIN
*********************************************************************************
*********************************************************************************
clear
...
*Import dataset
import excel "$projdir/data/raw_data_asian_wtgainbelow.xlsx"", sheet("sheet1") firstrow
...
gen bmi_new=.
replace bmi_new= 1 if bmi_r==3
replace bmi_new=2 if bmi_r==1
replace bmi_new=3 if bmi_r==2
lab def bmi 1 "Underweight" 2 "Normal weight" 3 "Overweight and obese combined", replace
lab val bmi_new bmi
...
* Run the meta-analysis and generate the forest plot with the new titles
